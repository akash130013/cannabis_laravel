        ...
        <div class="right-panel">
            ...
            <div class="inner-right-panel">
                ...
                <div class="white_wrapper  pd-20">
                        <!-- store filters -->
                        @include('Admin::includes.searchbar',['is_filterable' => true,'is_creater'=>false,'searchPlaceholder'=>trans('Admin::messages.driver_Placeholder'),'route_name'=>''])
                        <!-- store filters -->
                </div>
                <div class="search-filter-section driver-list">
                    ...
                    <div class="sidebar-header">
                        ...
                        <div class="row">
                            ...
                            <div class="btn-space text-center">
                                    ...
                                    <button class="green-fill-btn close_filter"  id='applyDistributorFilter'>Apply</button>
                                </div>
                ...
                <div class="white-wrapper clearfix">
                    ...
                    <table class="outlet-table table" id="driver_table">
...
<script src="{{asset('asset-admin/js/dataTables/driverList.js')}}"></script>
<script>
