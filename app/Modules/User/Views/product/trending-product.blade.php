...
@include('User::includes.navbar')
         ...
         <!--header close-->
      @section('content')
   <form action="{{route('users.product.trending')}}" method="get" id="filterFormId">
      @yield('nav-bar')        
       <!--section list filter-->
            ...
            <div class="custom_inner_conatiner">
               <div class="flex-row">
                  <div class="flex-col-sm-3">
                     ...
                     @if(isset($query) && !empty($query))<a href="{{route('users.product.trending')}}"><span class="clear_filter">Clear All</span></a>@endif
                     ...
                     <div class="filter_wrapper">
                        ...
                        <div class="filter_option_wrapper">
                           <ul>
                              ...
                              <li>
                                 <div class="input-holder acknowledge mt-23 clearfix">
                                    <input type="radio" name="stock_availability" class="all_filter" id="out_stock" value="2" @if(empty($query) || (isset($query['stock_availability']) && $query['stock_availability']==2)) checked @endif>
                  ...
                  <div class="flex-col-sm-9">
                   ...
                   @foreach ($productCategory['data'] as $item)
                                ...
                                <span class="pro_cateogry_name">{{$item['category_name']}}</span>
                                 ...
                                 <a href="{{route('users.store.detail',['id'=>encrypt($item['store_id'])])}}" target="_blank">
                                    <div class="product_by">
                                       <figure class="pro_logo"><img src="{{$item['store_image']}}"></figure>
                     ...
                     <div class="pagination">
                        <a href="@if($productCategory['nextPage']){{route('users.product.trending').'?page='.$productCategory['nextPage']}}@else javascript:void(0) @endif" class="next">Next</a>
                     </div>
