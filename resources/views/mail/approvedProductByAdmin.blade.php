        ...
        <tr>
            <td style="width: 100%">
                <table cellpadding="0" cellspacing="0" border="0" class="tablecl" style="border-top-left-radius: 4px;border-top-right-radius: 4px;width:100%;background-color:#fff; margin:0; padding: 50px 70px 30px;">
                    ...
                    <tr>
                        <td colspan="2" class="subhead" style="padding: 80px 0 20px; font-size: 24px; font-weight: 600;color:#444444;">Hello! {{$mailData['user_name']}}</td>
                    </tr>
                    <tr>
                        <td colspan="2" class="para" style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding: 15px 0 20px;">
                            Your request for product {{$mailData['product_name']}} is approved successfully. detail is listed below
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding:15px 20px 0px 0px;vertical-align: top;">Category- </td>
                        <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding:15px 20px 0px 0px;vertical-align: top;">{{$mailData['category_name']}}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding: 15px 20px 0px 0px;vertical-align: top;">CBD % - </td>
                        <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding: 15px 20px 0px 0px;vertical-align: top;">{{$mailData['cbd_per']}}</td>
                    </tr>
                    <tr>
                            <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding: 15px 20px 0px 0px;vertical-align: top;">THC % - </td>
                        <td style="font-size: 19px; font-weight: 400; line-height: 1.9; color: #444444; letter-spacing: 0.4px; padding: 15px 20px 0px 0px;vertical-align: top;">{{$mailData['thc_per']}}</td>
                    </tr>
                </table>
            </td>
        </tr>
