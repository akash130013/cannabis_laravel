                    ...
                    <tr>
                        <td valign="top" width="100%" class="header">
                            <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                        <td class="signup-msg" valign="top" style="color:#363636;font-size:16px;font-weight:600;text-transform:uppercase;line-height:1.3;padding: 0 0 0 34px;">
                                            Thanks for the signing up to keep in touch with <span> 420 Kingdom</span> We are excited to have you get started. First, you need to confirm your account.
                                        </td>
                                    ...
                                    <tr>
                                       ...
                                       {{-- Your Link is : <a href="{{route('user.verify.email',['param'=>$token])}}">click here </a>  --}}
                                       Your OTP is :  {{$token}}
                                        </td>
                                    </tr>
