...
$(function () {
    ...
    //    console.log("11111");
        ...
        //Open Alert BOX
        unblockWarningBox(text, id, type);
    });
...
//Unblock Data
var statusWarningBox = function (text, id, type) {
    swal({
 ...
 var inactiveWarningBox = function (text, id, type) {
    ...
    //Block Data
    var blockWarningBox = function (text, id, type) {
        swal({
                title: localMsg.BeSure,
                text: text,
                type: "warning",
    ...
    //Unblock Data
    var unblockWarningBox = function (text, id, type) {
        swal({
                title: localMsg.BeSure,
                text: text,
                type: "info",
    ...
    //change data status
    var changeStatus = function (id, type, toChange) {
    ...
    //     alert();
    //     var newStatus=$("#payment").val();
    //     if(newStatus=='' || newStatus==null){
    //         // $("#payment-error").text("Please select a payment status");
...
//    $("#Paymentstatus").onchange({
//        var newStatus=$(this).val();
//    })
   $('body').on('click',"#released-btn", function(){
    //  alert();
    var newPayStatus=2;
   
    var key=$("#key").val();
    var payIds=$("#allIds").val();
    ...
    var text = "You Want To Release Payment Status";
   
    var id =payIds;
    //type
    var type="paymentByAdminFund";
    if(key==2){
        type = "paymentByAdminSale";
    }
    console.log(key);
    
    //Open Alert BOX
    statusPaymentWarningBox(text, id, type, newPayStatus);
    // changeStatus(id, type, newStatus);
   });

   var statusPaymentWarningBox = function (text, id, type, newStatus) {
    swal({
            title: localMsg.BeSure,
            text: text,
            type: "info",
